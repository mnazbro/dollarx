...
public class BasicPathTest extends XPathTester {
    ...
    public void isAfterSiblingTest() {
        ...
        NodeList nodes = findAllByXpath(
                "<div>a</div><div class='container'><div class='a'><div class='a.a'></div></div><span class='b'/><span class='c'/></div><div>c</div><div>d</div><span class='abc'></span>",
                el);
    ...
    public void insideTopLevelVariationTest() {
        ...
        NodeList nodes = findAllByXpath(
                "<span/><div>foo</div><span></span><div>boo</div><span/><div class='3'/><span/><div/>", el);
    ...
    public void nestedIndexTest() {
        ...
        assertThat(
                el.toString(),
                equalTo("occurrence number 2 of (span, inside (occurrence number 2 of (div, that has class a)))"));
    }
    ...
    public void isImmediatelyBeforeSiblingTest() {
        ...
        NodeList nodes = findAllByXpath(
                "<div></div><span class='c'/><div>a</div><div class='container'><div class='a'><div class='a.a'></div></div><span class='b'/><span class='c'/></div><div>c</div><div>d</div><span class='abc'></span>",
                el);
        assertThat(nodes.getLength(), is(1));
        assertThat(getCssClass(nodes.item(0)), equalTo("b"));
    ...
    public void isParentTest() {
        Path el = element.that(hasClass("container").or(hasClass("a")))
                .inside(BasicPath.body.withClass("bar"))
                .inside(BasicPath.html)
                .parentOf(div);
        NodeList nodes = findAllByXpath(
                "<body class=\"bar\"><div>a</div><div class='container'><div class='a'><div class='a.a'></div></div><span class='b'/></div><div>c</div><div></div><span class='abc'></span></body>",
                el);
        assertThat(nodes.getLength(), is(2));
        ...
        assertThat(
                ...
                is(
                        equalTo(
                                "any element, (has class container or has class a), inside (document body, that has class bar), inside document, parent of div")));
    }
    ...
    public void indexVariationTest() {
        Path el = div.withGlobalIndex(1);
        NodeList nodes = findAllByXpath(
                "<div>a<div class='container'><div class='a'><div class='a.a'></div></div><span class='b'/></div><div>c</div><div></div><span class='abc'></span></div>",
                el);
        assertThat(nodes.getLength(), equalTo(1));
        assertThat(getCssClass(nodes.item(0)), equalTo("container"));
    ...
    public void insideAndIndexTest() {
        ...
        NodeList nodes = findAllByXpath(
                "<div>foo</div><span><div class='foo'>bar</div></span><span><div class='bar'>bar</div></span>", el);
        assertThat(nodes.getLength(), is(1));
    ...
    public void childNumberTest() {
        ...
        NodeList nodes = findAllByXpath(
                "<span></span><span class='a x'>a<span class='a y'>b</span><span class='a z'>c</span></span>", el);
    ...
    public void withTextTest() {
        ...
        NodeList nodes = findAllByXpath(
                "<div>ab</div><div>abc</div><div class='container'><div class='a'><div class='a.a'></div></div><span class='b'/></div><div>c</div><div></div><span class='abc'></span>",
                el);
        assertThat(nodes.getLength(), is(1));
    ...
    public void withClassesTest() {
        ...
        NodeList nodes =
                findAllByXpath("<div class=\"a\">a</div><div class=\"b\">b</div><div class=\"a b\">a b</div>", el);
        assertThat(nodes.getLength(), is(1));
    ...
    public void withTextContainingTest() {
        ...
        NodeList nodes = findAllByXpath(
                "<div>ab</div><div>xabc</div><div class='container'><div class='a'><div class='a.a'></div></div><span class='b'/></div><div>c</div><div></div><span class='abc'></span>",
                el);
        assertThat(nodes.getLength(), is(2));
        assertThat(getText(nodes.item(0)), equalTo("ab"));
    ...
    public void andTest() {
        ...
        NodeList nodes = findAllByXpath(
                "<div>ab</div><div>xabc</div><div class='container'><div class='a dfdsf'>xyz<div class='a.a'></div></div><span class='b'/></div><div>c</div><div></div><span class='abc'></span>",
                el);
        assertThat(nodes.getLength(), is(1));
    ...
    public void withDescriptionAndAdditionalProperty() {
        ...
        NodeList nodes = findAllByXpath(
                "<div>a</div><div class='container'><div class='a'><div class='foo a.a'></div></div><span class='b'/></div><div>c</div><div></div><span class='abc'></span>",
                el);
        assertThat(nodes.getLength(), is(2));
        assertThat(getCssClass(nodes.item(0)), equalTo("container"));
        assertThat(getCssClass(nodes.item(1)), equalTo("a"));
    ...
    public void firstOccurrenceTest() {
        ...
        NodeList nodes = findAllByXpath(
                "<div>a</div><div class='container'><div class='a first'><div class='foo a.a'></div></div><span class='b'/></div><div>c</div><div></div><span class='abc'></span>",
                el);
        assertThat(nodes.getLength(), is(1));
    ...
    public void lastOccurrenceTest() {
        ...
        NodeList nodes = findAllByXpath(
                "<div>a</div><div class='container'><div class='a first'><div class='foo a.a'></div></div><span class='b'/></div><div>c</div><div></div><span class='last a'></span>",
                el);
        assertThat(nodes.getLength(), is(1));
    ...
    public void underlyingToString() {
        BasicPath path = new PathBuilder()
                .withXpath("Johhny")
    ...
    public void orWithImmediatelyAfter() {
        ...
        assertThat(
                el.getXPath().get(),
                equalTo("*[(self::div[preceding-sibling::*[1]/self::span]) | (self::input[preceding::label])]"));
        NodeList nodes = findAllByXpath(
                "<div>a<span class='container'>aaa</span><div>bbb</div></div><span></span><a></a><div>ccc</div><label></label><input></input>",
                el);
        assertThat(nodes.getLength(), equalTo(2));
    ...
    public void withTitle() {
        ...
        NodeList nodes = findAllByXpath(
                "<div title='asd'>1</div><div title='johnny' /><div title='johnny'>2</div><div>3</div>", el);
        assertThat(nodes.getLength(), is(2));
