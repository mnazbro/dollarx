...
public class HighLevelPathsIntegration {
    ...
    public void testCheckbox2() {
        driver.get("https://www.w3schools.com/tags/tryit.asp?filename=tryhtml5_input_type_checkbox");
        driver.switchTo().frame("iframeResult");
        CheckBox checkBox = CheckBoxes.checkboxForInput(Inputs.inputForLabel("I have a car"), "have car");
        checkBox.check();
        assertTrue(checkBox.isChecked());
    ...
    public void testCheckboxUnceck1() {
        driver.get("https://www.w3schools.com/tags/tryit.asp?filename=tryhtml5_input_type_checkbox");
        driver.switchTo().frame("iframeResult");
        CheckBox checkBox = CheckBoxes.checkboxForInput(Inputs.genericFormInputBeforeField("I have a car"), "have car");
        checkBox.check();
        checkBox.uncheck();
        assertFalse(checkBox.isChecked());
    }
    ...
    @Test
    public void genericInputFieldShouldWorkForMostCasesElementIsNotReplaced()
    ...
    @Test
    public void genericInputFieldShouldWorkForMostCasesApproximateDeletion()
            throws Operations.OperationFailedException {
        load_html_file("input-example3.html");
        Path myInput = Inputs.genericFormInputAfterField("xxx");
    ...
    @Test
    public void changeInputWithEnterApproximateDeletionAndVerifyItWasChanged()
            throws Operations.OperationFailedException {
        load_html_file("input-example3.html");
        Path myInput = Inputs.inputForLabel("xxx");
