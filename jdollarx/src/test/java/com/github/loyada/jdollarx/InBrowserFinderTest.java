...
public class InBrowserFinderTest {
    ...
    public void findWithUnderlying() {
        ...
        Path path =
                BasicPath.builder().withUnderlying(webElement).withXpath("div").build();
    ...
    public void findNTimes() {
        ...
        assertThat(
                InBrowserFinder.findPageWithNumberOfOccurrences(driverMock, BasicPath.div, 5),
                is(equalTo(webElement2)));
    }
