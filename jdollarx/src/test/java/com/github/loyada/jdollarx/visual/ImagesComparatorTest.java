...
public class ImagesComparatorTest {
    ...
    public void equalityWrongWidth() {
        try {
            verifyImagesAreEqual(image1, image1.getSubimage(0, 0, image1.getWidth() - 1, image1.getHeight()));
            fail("should throw");
        } catch (AssertionError e) {
    ...
    public void equalityWrongHeight() {
        try {
            verifyImagesAreEqual(image1, image1.getSubimage(0, 0, image1.getWidth(), image1.getHeight() - 5));
            fail("should throw");
        } catch (AssertionError e) {
    ...
    public void SimilarWrongWidth() {
        try {
            verifyImagesAreSimilar(image1, image1.getSubimage(0, 0, image1.getWidth() - 20, image1.getHeight()), 10);
            fail("should throw");
        } catch (AssertionError e) {
            assertThat(e.getMessage(), startsWith("width"));
        }
    ...
    public void SimilarWrongHeight() {
        try {
            verifyImagesAreSimilar(image1, image1.getSubimage(0, 0, image1.getWidth(), image1.getHeight() - 5), 10);
            fail("should throw");
        } catch (AssertionError e) {
            assertThat(e.getMessage(), startsWith("height"));
        }
    ...
    public void similarMinorDifferencesInColor() {
        ...
        IntStream.range(270, 320).forEach(y -> {
            IntStream.range(480, 520).forEach(x -> {
                ...
                Color c2 = new Color(
                        (int) (c1.getRed() * 0.95), (int) (c1.getGreen() * 0.95), (int) (c1.getBlue() * 0.95));
    ...
    public void croppedPictures1() {
        BufferedImage shiftedImage = image2.getSubimage(0, 0, image2.getWidth() - 30, image2.getHeight() - 50);
        verifyImagesAreEqualWithShift(shiftedImage, image1, 50);
    }

    @Test
    public void croppedPictures2() {
        BufferedImage shiftedImage = image2.getSubimage(20, 0, image2.getWidth() - 20, image2.getHeight());
        verifyImagesAreEqualWithShift(image1, shiftedImage, 50);
    }

    @Test
    public void shiftedCroppedPictures1() {
        BufferedImage shiftedImage = image2.getSubimage(20, 30, image2.getWidth() - 30, image2.getHeight() - 50);
        verifyImagesAreEqualWithShift(shiftedImage, image1, 50);
    }
    ...
    public void errorImageVerify() throws IOException {
        ...
        BufferedImage expectedErrImage =
                ImageIO.read(new File(classLoader.getResource("err_sample.png").getFile()));
    ...
    public void errorImageDifferentDimensions() throws IOException {
        BufferedImage otherImage =
                new BufferedImage(image1.getWidth() + 1, image1.getHeight(), BufferedImage.TYPE_INT_RGB);
    ...
    public void verifyShiftedImageComparison() throws IOException, URISyntaxException {
        ...
        BufferedImage shiftedImage =
                expectedImage.getSubimage(20, 30, expectedImage.getWidth() - 30, expectedImage.getHeight() - 50);
