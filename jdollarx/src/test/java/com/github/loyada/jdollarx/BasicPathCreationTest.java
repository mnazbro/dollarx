...
public class BasicPathCreationTest {
    ...
    public void complexBeforeAndAfter() {
        ...
        assertThat(
                el.toString(),
                is(equalTo("div, that is before: span, before (span, that is after: (div, that is before: span))")));
    }
    ...
    public void withClassAndInside() {
        ...
        assertThat(
                ...
                is(
                        equalTo(
                                "span[contains(concat(' ', normalize-space(@class), ' '), ' foo ')][ancestor::div[contains(concat(' ', normalize-space(@class), ' '), ' ui-dialog ')]]")));
        assertThat(
                el.toString(),
                is(equalTo("span, that has class foo, and has ancestor: (div, that has class ui-dialog)")));
    }
    ...
    public void divWithClassOrSpan() {
        ...
        assertThat(
                ...
                is(
                        equalTo(
                                "*[(self::div[contains(concat(' ', normalize-space(@class), ' '), ' foo ')]) | (self::span)]")));
