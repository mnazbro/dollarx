...
public class SingltonBrowserImage {
     ...
     * @throws IOException - file could not be read
     */
    public static void assertImageIsEqualToExpected(InputStream actualImage, InputStream expectedImageInput)
            throws IOException {
    ...
    public void assertImageIsEqualToExpectedWithShiftAndCrop(InputStream expectedImageInput, int maxShift)
            throws IOException {
        Images.assertImageIsEqualToExpectedWithShiftAndCrop(browser(), el, expectedImageInput, maxShift);
    }
     ...
     * @throws IOException - file could not be read
     */
    public void assertImageIsSimilarToExpectedWithShift(
            InputStream expectedImageInput, int maxBadPixelsRatio, int maxShift) throws IOException {
    ...
    public void assertImageIsSimilarToExpectedWithFilter(
            InputStream filterImageInput, InputStream expectedImageInput, int maxBadPixelsRatio) throws IOException {
        Images.assertImageIsSimilarToExpectedWithFilter(
                browser(), el, filterImageInput, expectedImageInput, maxBadPixelsRatio);
    }
     ...
     * @throws IOException
     */
    public static void assertWindowIsSimilarToExpected(InputStream expectedImageInput, int maxBadPixelsRatio)
            throws IOException {
    ...
    public static void assertWindowIsSimilarToExpectedWithFilter(
        ...
        Images.assertWindowIsSimilarToExpectedWithFilter(
                browser(), filterImageInput, expectedImageInput, maxBadPixelsRatio);
    }
